...
class LaserWeaponArmory(Scene):
	...
	def enter(self):
        ...
        if guess == code:
            print(dedent("""
                The container clicks open and the seas breaks, letting gas out. You grab the neutron bomb and run as fast as you can to the bridge where you must place it in the right spot.
                """))
            return "the_bridge"
        else:
            print(dedent("""
